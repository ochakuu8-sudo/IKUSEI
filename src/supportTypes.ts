...
export type StoryEvent = { id: string; title: string; place: PlaceId; lines: string[] };
...
export const emptySupportState = (): SupportState => ({
  saveVersion: 9, obligations: [], offerStates: {}, capabilities: [], history: [],
  unlockedPeople: [], unlockedPlaces: [], newPeople: [], newPlaces: [], newEvents: [],
